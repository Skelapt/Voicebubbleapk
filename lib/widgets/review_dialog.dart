...
/// - Free users: Shown when their bubble-unlocked free time runs out;
///   leaving a review unlocks +1 min on top
    ...
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          if (isFreeUser) ...[
            const Text(
              'You\'ve used the free time you unlocked. Leave a review and grab one more minute.',
